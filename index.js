...
function generateReadme(projectName, description, installationInstructions, usageInstructions, license, contributors, tests) {
  ...
  inquirer.prompt(questions).then(answers => {
    const readme = generateReadme(answers.projectName, answers.description, answers.installationInstructions, answers.usageInstructions, answers.license, answers.contributors, answers.tests);
    const fs = require('fs');
